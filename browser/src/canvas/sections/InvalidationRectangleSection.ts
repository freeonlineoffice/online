...
class InvalidationRectangleSection extends CanvasSectionObject {
	...
	*/
	...
	drawingOrder: number =
		app.CSections.DefaultForDocumentObjects.drawingOrder;
	...
	onDraw(
		...
		const xDiff =
			anchor[0] - app.activeDocument.activeView.viewedRectangle.pX1;
		const yDiff =
			anchor[1] - app.activeDocument.activeView.viewedRectangle.pY1;
