...
export class CommentSection extends CanvasSectionObject {
	...
	public newAnnotationMobile (comment: any, addCommentFn: any, isMod: any): void {
		...
		app.layoutingService.appendLayoutingTask(() => {
			...
			empty = '',
			tagDiv = 'div';
			const author = L.DomUtil.create('table', 'lool-annotation-table');
			const tbody = L.DomUtil.create('tbody', empty, author);
			const tr = L.DomUtil.create('tr', empty, tbody);
			const tdImg = L.DomUtil.create(tagTd, 'lool-annotation-img', tr);
			const tdAuthor = L.DomUtil.create(tagTd, 'lool-annotation-author', tr);
			...
			const contentAuthor = L.DomUtil.create(tagDiv, 'lool-annotation-content-author', tdAuthor);
			const contentDate = L.DomUtil.create(tagDiv, 'lool-annotation-date', tdAuthor);
