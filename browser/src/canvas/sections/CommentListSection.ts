...
export class CommentSection extends CanvasSectionObject {
	...
	private layout (relayout: boolean = true): void {
		...
		if (lastY > app.activeDocument.fileSize.pY) {
			app.activeDocument.activeView.viewSize = new lool.SimplePoint(horizontalScroll, lastY * app.pixelsToTwips);
			this.containerObject.requestReDraw();
		}
		else
			app.activeDocument.activeView.viewSize = new lool.SimplePoint(horizontalScroll, app.activeDocument.fileSize.y);
