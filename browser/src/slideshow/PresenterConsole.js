		...
		return `
			...
			<body>
                                ...
                                <main id="main-content">
								  <div id="toolbar">
									<button type="button" id="close-slides" data-looltip="${this.labels.goBack}">
                                    ...
                                    <div id="first-presentation">
										<div id="timer-container">
											<div id="timer"></div>
											 <div id="timer-controls">
												<button type="button" id="pause" data-looltip="${this.labels.pause}">
													<img src="images/presenterscreen-ButtonPauseTimerNormal.svg">
												</button>
												<button type="button" id="restart" data-looltip="${this.labels.restart}">
                                        ...
                                        <div id='current-slide-container'>
											...
											<div id="navigation-container">
												<button type="button" id="prev" data-looltip="${this.labels.previous}">
													<img src="images/presenterscreen-ButtonSlidePreviousSelected.svg">
												</button>
												<div id="title-current">${this.labels.currentSlide}</div>
												<button type="button" id="next" data-looltip="${this.labels.next}">
													<img src="images/presenterscreen-ButtonEffectNextSelected.svg">
												</button>
											</div>
											<div id="action-buttons-container">
												<button type="button" id="notes" data-looltip="${this.labels.notes}">
													<img src="images/presenterscreen-ButtonNotesNormal.svg">
												</button>
												<button type="button" id="slides" data-looltip="${this.labels.slides}">
