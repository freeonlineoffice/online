...
L.Map = L.Evented.extend({
	...
	initialize: function (id, options) {
		...
		this._progressBar = L.progressOverlay(new lool.Point.toPoint(150, 25));
	...
	_resetView: function (center, zoom, preserveMapOffset, afterZoomAnim) {
		...
		if (!preserveMapOffset) {
			L.DomUtil.setPosition(this._mapPane, new lool.Point(0, 0));
		}
	...
	_getMapPanePos: function () {
		return L.DomUtil.getPosition(this._mapPane) || new lool.Point(0, 0);
	},
