...
L.Map.Drag = L.Handler.extend({
	...
	_onPreDrag: function () {
		...
		if (this._draggable._newPos.x !== pos.x) {
			...
			this._dragEdgeOffset.x = Math.min(
				this._dragEdgeOffset.x,
				clampedX - this._draggable._newPos.x,
			);
			this._draggable._newPos.x =
				this._draggable._newPos.x + this._dragEdgeOffset.x;
		}
		...
		if (this._draggable._newPos.y !== pos.y) {
			...
			this._dragEdgeOffset.y = Math.min(
				this._dragEdgeOffset.y,
				clampedY - this._draggable._newPos.y,
			);
			this._draggable._newPos.y =
				this._draggable._newPos.y + this._dragEdgeOffset.y;
		}
	},
