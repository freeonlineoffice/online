...
namespace lool {
	...
	export class SplitPanesContext {
		...
		public getViewRectangles(): lool.SimpleRectangle[] {
			...
			); // If view is not splitted, this will be the only view rectangle.
		...
		*/
			...
			if (this._splitPos.x) {
				...
				const topRightPane: lool.SimpleRectangle =
					app.activeDocument.activeView.viewedRectangle.clone();
				const width =
					app.activeDocument.activeView.viewedRectangle.pWidth -
			...
			if (this._splitPos.y) {
				...
				const bottomLeftPane =
					app.activeDocument.activeView.viewedRectangle.clone();
				const height =
					app.activeDocument.activeView.viewedRectangle.pHeight -
