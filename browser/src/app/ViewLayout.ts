...
class ViewLayoutBase {
	...
	private lastViewedRectangle: lool.SimpleRectangle; // Previously viewed rectangle.
	...
	protected _viewedRectangle: lool.SimpleRectangle; // Currently viewed rectangle.
	protected _viewSize: lool.SimplePoint; // Scrollable area.
	...
	public refreshScrollProperties(): any {
		...
		this.scrollProperties.horizontalScrollStep =
			documentAnchor.size[0] / 2;
	}
