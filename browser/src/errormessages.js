...
errorMessages.emptyhosturl = _(
	'The host URL is empty. The loolwsd server is probably misconfigured, please contact the administrator.',
);
errorMessages.limitreached = _(
...
errorMessages.limitreachedprod = _(
...
errorMessages.serviceunavailable = _(
	'Service is unavailable. Please try again later and report to your administrator if the issue persists.',
);
errorMessages.unauthorized = _(
	'Unauthorized WOPI host. Please try again later and report to your administrator if the issue persists.',
);
errorMessages.verificationerror = _(
	"Authorization error was: '{errormessage}'.",
);
errorMessages.wrongwopisrc = _(
	'Wrong or missing WOPISrc parameter, please contact support.',
);
errorMessages.sessionexpiry = _(
	'Your session will expire in {time}. Please save your work and refresh the session (or webpage) to continue. You might need to login again.',
);
errorMessages.sessionexpired = _(
	'Your session has expired. Further changes to the document might not be saved. Please refresh the session (or webpage) to continue. You might need to login again.',
);
errorMessages.faileddocloading = _(
...
errorMessages.docunloadingretry = _(
	'Cleaning up the document from the last session.',
);
errorMessages.docunloadinggiveup = _(
	'We are in the process of cleaning up this document from the last session, please try again later.',
);
errorMessages.clusterconfiguration = _(
...
errorMessages.websocketproxyfailure = _(
...
errorMessages.websocketgenericfailure = _(
...
if (window.ThisIsAMobileApp) {
	...
	errorMessages.storage = {
		...
		savediskfull: _(
			'Save failed due to no storage space left. Document will now be read-only. Please make sure enough disk space is available and try to save again.',
		),
		savetoolarge: _(
