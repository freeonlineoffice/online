...
L.Control.MobileWizardWindow = L.Control.extend({
	...
	_isSlidePropertyPanel: function (data) {
		var backgroundPanel = app.LOUtil.findItemWithAttributeRecursive(
			data,
			'id',
			'SlideBackgroundPanel',
		);
		var layoutPanel = app.LOUtil.findItemWithAttributeRecursive(
			data,
			'id',
			'SdLayoutsPanel',
		);
	...
	_modifySidebarLayout: function (data) {
		...
		if (deck) {
			...
			var stylesIdx = app.LOUtil.findIndexInParentByAttribute(
				deck,
				'name',
				'StylesPropertyPanel',
			);
			var textIdx = app.LOUtil.findIndexInParentByAttribute(
				deck,
				'name',
				'TextPropertyPanel',
			);
