...
window.L.Control.NotebookbarCalc = window.L.Control.NotebookbarWriter.extend({
	...
	getHomeTab: function () {
		var content = [
									...
									},
									{
										...
										applyCallback: function () {
											app.map.sendUnoCommand(
												window.getBorderStyleUNOCommand(
													0,
													0,
													1,
													0,
			...
			{
				type: 'separator',
				id: 'home-numberformatdecrementdecimals-break',
				orientation: 'vertical',
			},
			{
				type: 'overflowgroup',
			...
			{
				type: 'separator',
				id: 'home-columnoperations-break',
				orientation: 'vertical',
			},
			{
				type: 'overflowgroup',
	...
	getLayoutTab: function () {
		var content = [
			...
			{
				type: 'separator',
				id: 'layout-pageformatdialog-break',
				orientation: 'vertical',
			},
			{
			...
			{
				type: 'separator',
				id: 'layout-sheetrighttoleft-break',
				orientation: 'vertical',
			},
			{
				type: 'overflowgroup',
			...
			{
				type: 'separator',
				id: 'layout-printrangesmenu-break',
				orientation: 'vertical',
			},
			{
			...
			{
				type: 'separator',
				id: 'layout-columnmenuwidth-break',
				orientation: 'vertical',
			},
			{
				type: 'overflowgroup',
	...
	getViewTab: function () {
		var content = [
			...
			{
				type: 'separator',
				id: 'layout-freezepanesrow-break',
				orientation: 'vertical',
			},
			{
				id: 'colrowhighlight',
			...
			{
				type: 'separator',
				id: 'layout-colrowhighlight-break',
				orientation: 'vertical',
			},
			{
				type: 'overflowgroup',
			...
			{
				type: 'separator',
				id: 'layout-invertbackground-break',
				orientation: 'vertical',
			},
			{
				id: 'view-sidebardeck',
	...
	getInsertTab: function () {
		var content = [
			...
			{
				type: 'separator',
				id: 'insert-deletepivottable-break',
				orientation: 'vertical',
			},
			{
				type: 'overflowgroup',
			...
			{
				type: 'separator',
				id: 'insert-functiondialog-break',
				orientation: 'vertical',
			},
			{
				id: 'HyperlinkDialog',
			...
			{
				type: 'separator',
				id: 'insert-insertcurrenttime-break',
				orientation: 'vertical',
			},
			{
			...
			{
				type: 'separator',
				id: 'insert-editheaderandfooter-break',
				orientation: 'vertical',
			},
			{
	...
	getFormulaTab: function () {
		var content = [
			...
			{
				type: 'separator',
				id: 'formula-insertformula-break',
				orientation: 'vertical',
			},
			{
				type: 'overflowgroup',
			...
			{
				type: 'separator',
				id: 'formula-nameoperations-break',
				orientation: 'vertical',
			},
			{
				type: 'overflowgroup',
			...
			{
				type: 'separator',
				id: 'formula-rangeoperations-break',
				orientation: 'vertical',
			},
			{
				type: 'container',
	...
	getDataTab: function () {
		var content = [
			...
			{
				type: 'separator',
				id: 'data-datafilterremovefilter-break',
				orientation: 'vertical',
			},
			{
				type: 'overflowgroup',
	...
	getFormatTab: function () {
		var content = [
			...
			{
				type: 'separator',
				id: 'format-conditionalformatmenu-break',
				orientation: 'vertical',
			},
			{
