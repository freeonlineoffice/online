...
function _drawingAreaControl (parentContainer, data, builder) {
	...
	if (
		JSDialog.isWidgetInModalPopup(data) &&
		image.width == 0 &&
		image.height == 0
	) {
