...
/* global JSDialog FormulaBarSelectionHandle lool */
...
function _setSelection(builder, container, wrapper, cursorLayer, handleLayer, textLayer, text, startX, endX, startY, endY) {
	...
	startHandle.setPosition(new lool.SimplePoint(selectionStartPosition.left - cursorLayerPosition.left, selectionStartPosition.bottom - cursorLayerPosition.top));
	...
	endHandle.setPosition(new lool.SimplePoint(selectionEndPosition.right - cursorLayerPosition.left, selectionEndPosition.bottom - cursorLayerPosition.top));
