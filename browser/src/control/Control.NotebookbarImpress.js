...
window.L.Control.NotebookbarImpress = window.L.Control.NotebookbarWriter.extend({
	...
	getHomeTab: function () {
		var content = [
				...
				children: [
					{
						...
						type: 'menubutton',
						applyCallback: () => {
							app.map.sendUnoCommand('.uno:InsertPage');
						},
						text: _('New'),
						command: '.uno:InsertPage',
						accessibility: {
			...
			{
				type: 'separator',
				id: 'home-insertobjectchart-break',
				orientation: 'vertical',
			},
			{
				type: 'overflowgroup',
	...
	getFormatTab: function () {
		var content = [
			...
			{
				type: 'separator',
				id: 'format-paragraphdialog-break',
				orientation: 'vertical',
			},
			{
	...
	getInsertTab: function () {
		var content = [
										...
										? {
												...
												accessibility: {
													...
													combination:
														'MM',
													de: null,
												}, // IM was already taken, so 'MM' for MultiMedia
											}
										: {},
								],
							},
			...
			{
				type: 'separator',
				id: 'insert-insertslidetitlefield-break',
				orientation: 'vertical',
			},
			{
				type: 'overflowgroup',
	...
	getDesignTab: function () {
		var content = [
			...
			{
				type: 'separator',
				id: 'design-headerandfooter-break',
				orientation: 'vertical',
			},
			{
	...
	getTableTab: function () {
		var content = [
			...
			{
				type: 'separator',
				id: 'table-merge-split-table-break',
				orientation: 'vertical',
			},
			{
				type: 'overflowgroup',
