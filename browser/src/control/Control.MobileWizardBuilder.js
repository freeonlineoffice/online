...
L.Control.MobileWizardBuilder = L.Control.JSDialogBuilder.extend({
	...
	_overrideHandlers: function () {
		...
		this._controlHandlers['mobile-popup-container'] =
			this._mobilePopupContainer;
		...
		this._controlHandlers['submenutabs'] =
			JSDialog.mobileSubmenuTabControl;
		...
		this._toolitemHandlers['.uno:FontworkAlignmentFloater'] =
			function () {
				return false;
			};
		...
		this._toolitemHandlers['.uno:Grow'] = function () {
			return false;
		};
		this._toolitemHandlers['.uno:Shrink'] = function () {
			return false;
		};
		this._toolitemHandlers['.uno:StyleUpdateByExampleimg'] = function () {
			return false;
		};
		this._toolitemHandlers['.uno:StyleNewByExampleimg'] = function () {
			return false;
		};
		...
		this._toolitemHandlers['.uno:FontworkShapeType'] =
			this._fontworkShapeControl;
		this._toolitemHandlers['SelectWidth'] = this._lineWidthControl;
		this._toolitemHandlers['.uno:XLineStyle'] =
	...
	baseSpinField: function (parentContainer, data, builder, customCallback) {
		...
		var commandName =
			data.id && data.id.startsWith('.uno:')
				? data.id.substring('.uno:'.length)
				: data.id;
		if (
			commandName &&
			commandName.length &&
			...
			var icon =
				data.id === 'Transparency'
					? app.LOUtil.getIconNameOfCommand('settransparency')
					: app.LOUtil.getIconNameOfCommand(data.id);
		...
		var controlsContainer = L.DomUtil.create(
			'div',
			'spinfieldcontrols',
			div,
		);
		...
		if (data.step != undefined) $(spinfield).attr('step', data.step);
	...
	_listboxControl: function (parentContainer, data, builder) {
		...
		if (data.selectedEntries) {
			...
			else title = data.entries[data.selectedEntries[0]];
		}
	...
	_checkboxControl: function (parentContainer, data, builder) {
		...
		if (data.checked === true) $(checkbox).prop('checked', true);
	...
	_radiobuttonControl: function (parentContainer, data, builder) {
		...
		JSDialog.SynchronizeDisabledState(container, [
			radiobutton,
			radiobuttonLabel,
		]);
	...
	_editControl: function (parentContainer, data, builder, callback) {
		...
		edit.dir = 'auto';
		if (data.password) edit.type = 'password';
						...
						children: [
							{
								type: 'toolitem',
								text: _UNO(
									'.uno:FontworkShapeType.fontwork-plain-text',
								),
							...
							},
							{
								type: 'toolitem',
								text: _UNO(
									'.uno:FontworkShapeType.fontwork-wave',
								),
							...
							},
							{
								type: 'toolitem',
								text: _UNO(
									'.uno:FontworkShapeType.fontwork-inflate',
								),
							...
							},
							{
								type: 'toolitem',
								text: _UNO(
									'.uno:FontworkShapeType.fontwork-stop',
								),
							...
							},
							{
								type: 'toolitem',
								text: _UNO(
									'.uno:FontworkShapeType.fontwork-curve-up',
								),
							...
							},
							{
								type: 'toolitem',
								text: _UNO(
									'.uno:FontworkShapeType.fontwork-curve-down',
								),
...

							{
								type: 'toolitem',
								text: _UNO(
									'.uno:FontworkShapeType.fontwork-triangle-up',
								),
							...
							},
							{
								type: 'toolitem',
								text: _UNO(
									'.uno:FontworkShapeType.fontwork-triangle-down',
								),
							...
							},
							{
								type: 'toolitem',
								text: _UNO(
									'.uno:FontworkShapeType.fontwork-fade-right',
								),
							...
							},
							{
								type: 'toolitem',
								text: _UNO(
									'.uno:FontworkShapeType.fontwork-fade-left',
								),
							...
							},
							{
								type: 'toolitem',
								text: _UNO(
									'.uno:FontworkShapeType.fontwork-fade-up',
								),
							...
							},
							{
								type: 'toolitem',
								text: _UNO(
									'.uno:FontworkShapeType.fontwork-fade-down',
								),
...

							{
								type: 'toolitem',
								text: _UNO(
									'.uno:FontworkShapeType.fontwork-slant-up',
								),
							...
							},
							{
								type: 'toolitem',
								text: _UNO(
									'.uno:FontworkShapeType.fontwork-slant-down',
								),
							...
							},
							{
								type: 'toolitem',
								text: _UNO(
									'.uno:FontworkShapeType.fontwork-fade-up-and-right',
								),
							...
							},
							{
								type: 'toolitem',
								text: _UNO(
									'.uno:FontworkShapeType.fontwork-fade-up-and-left',
								),
							...
							},
							{
								type: 'toolitem',
								text: _UNO(
									'.uno:FontworkShapeType.fontwork-chevron-up',
								),
							...
							},
							{
								type: 'toolitem',
								text: _UNO(
									'.uno:FontworkShapeType.fontwork-chevron-down',
								),
...

							{
								type: 'toolitem',
								text: _UNO(
									'.uno:FontworkShapeType.fontwork-arch-up-curve',
								),
							...
							},
							{
								type: 'toolitem',
								text: _UNO(
									'.uno:FontworkShapeType.fontwork-arch-down-curve',
								),
							...
							},
							{
								type: 'toolitem',
								text: _UNO(
									'.uno:FontworkShapeType.fontwork-circle-curve',
								),
							...
							},
							{
								type: 'toolitem',
								text: _UNO(
									'.uno:FontworkShapeType.fontwork-open-circle-curve',
								),
...

							{
								type: 'toolitem',
								text: _UNO(
									'.uno:FontworkShapeType.fontwork-arch-up-pour',
								),
							...
							},
							{
								type: 'toolitem',
								text: _UNO(
									'.uno:FontworkShapeType.fontwork-arch-down-pour',
								),
							...
							},
							{
								type: 'toolitem',
								text: _UNO(
									'.uno:FontworkShapeType.fontwork-circle-pour',
								),
							...
							},
							{
								type: 'toolitem',
								text: _UNO(
									'.uno:FontworkShapeType.fontwork-open-circle-pour',
								),
	...
	_colorControl: function (parentContainer, data, builder) {
		...
		var contentNode = {
			...
			onshow: L.bind(colorPickerControl.onShow, colorPickerControl),
		};
	...
	_lineWidthControl: function (parentContainer, data, builder) {
		var values = [0.0, 0.5, 0.8, 1.0, 1.5, 2.3, 3.0, 4.5, 6.0];

		var currentWidth = parseInt(
			builder.map['stateChangeHandler'].getItemValue('.uno:LineWidth'),
		);
		var currentWidthText = currentWidth
			? String(parseFloat(currentWidth) / 100.0)
			: '0.5';
	...
	_panelHandler: function (parentContainer, data, builder) {
		...
		if (data.hidden === true) {
			var control = parentContainer.querySelector(
				"[id='" + data.id + "']",
			);
	...
	_explorableToolItemHandler: function (parentContainer, data, builder) {
		...
		var nodeId =
			data.command.indexOf('.uno:') === 0
				? data.command.substr('.uno:'.length)
				: data.command;
		var contentNode = {
			id: nodeId,
			type: 'mobile-popup-container',
			children: [],
			onshow: onShow,
		};
		var iconPath = app.LOUtil.getIconNameOfCommand(data.command);
	...
	_modifySidebarNodes: function (data) {
		for (var i = data.length - 1; i >= 0; i--) {
			if (
				...
				(data[i].command === 'sidebargradient' &&
					data[i].type === 'toolitem') ||
				(data[i].id === 'radiusglow' &&
					data[i].type === 'fixedtext') ||
				(data[i].id === 'radiussoftedge' &&
					data[i].type === 'fixedtext')
			) {
				data.splice(i, 1);
			}
	...
	_countVisiblePanels: function (panels) {
		...
		for (var i in panels)
			if (
				panels[i].type === 'panel' &&
				(!panels[i].hidden || panels[i].hidden === false)
			)
				count++;
	...
	isFindReplaceComboox: function (builder, data) {
		return (
			data.type === 'combobox' &&
			(data.id === 'searchterm' || data.id === 'replaceterm')
		);
	},
	...
	requiresOverwriting: function (builder, data) {
		if (
			builder.isHyperlinkTarget(builder, data) ||
	...
	build: function (parent, data) {
		...
		for (var childIndex in data) {
			...
			if (childData.dialogid) {
				var dialog = L.DomUtil.createWithId(
					'div',
					childData.dialogid,
					childObject,
				);
			...
			if (
				this.wizard._dialogid === 'ContentControlDialog' &&
				childData.id !== ''
			) {
				var div = L.DomUtil.createWithId(
					'div',
					childData.id,
					childObject,
				);
			...
			if (
				childData.children &&
				this._countVisiblePanels(childData.children) == 1
			) {
				...
				childData.children &&
				this._countVisiblePanels(childData.children) == 2
			) {
				...
				childType == 'tabcontrol' &&
				childData.children.length > 3
			) {
