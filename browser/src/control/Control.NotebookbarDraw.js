...
window.L.Control.NotebookbarDraw = window.L.Control.NotebookbarImpress.extend({
	...
	getHomeTab: function () {
		var content = [
			...
			{
				type: 'separator',
				id: 'home-insertconnectorsmenu-break',
				orientation: 'vertical',
			},
			{
				type: 'container',
			...
			{
				type: 'separator',
				id: 'home-fillcolorpickermenu-break',
				orientation: 'vertical',
			},
			{
				type: 'overflowgroup',
	...
	getLayoutTab: function () {
		var content = [
			...
			{
				type: 'separator',
				id: 'layout-headerandfooter-break',
				orientation: 'vertical',
			},
			{
				type: 'overflowgroup',
			...
			{
				type: 'separator',
				id: 'layout-selectbackground-break',
				orientation: 'vertical',
			},
			{
	...
	getInsertTab: function () {
		var content = [
			...
			{
				type: 'separator',
				id: 'insert-pagetitlefield-break',
				orientation: 'vertical',
			},
			{
				type: 'overflowgroup',
	...
	getFormatTab: function () {
		var content = [
			...
			{
				type: 'separator',
				id: 'font-objecttitledescription-break',
				orientation: 'vertical',
			},
			{
