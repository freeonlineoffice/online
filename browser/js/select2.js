			...
			Utils.Decorate = function (SuperClass, DecoratorClass) {
				...
				var calledMethod = function (methodName) {
					...
					if (methodName in DecoratedClass.prototype) {
						originalMethod =
							DecoratedClass.prototype[methodName];
					}
			...
			function ($, Utils) {
				...
				Results.prototype.bind = function (container, $container) {
					...
					container.on('results:previous', function () {
						...
						var $options =
							self.$results.find('[aria-selected]');
		...
		S2.define('select2/i18n/en', [], function () {
			...
			return {
				...
				inputTooLong: function (args) {
					...
					var message =
						'Please delete ' + overChars + ' character';
			...
			function (require, $, Defaults, Utils) {
				...
				Options.prototype.fromElement = function ($e) {
					...
					for (
						...
						if (
							attributeName.substr(0, prefix.length) ==
							prefix
						) {
		...
		S2.define(
			...
			function ($, CompatUtils) {
				...
				DropdownCSS.prototype.render = function (decorated) {
					...
					dropdownCssAdapter =
						dropdownCssAdapter || _dropdownAdapter;
		...
		S2.define('select2/dropdown/attachContainer', [], function () {
			...
			AttachContainer.prototype.position = function (
				...
				var $dropdownContainer =
					$container.find('.dropdown-wrapper');
