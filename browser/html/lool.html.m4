...
m4_dnl# EMSCRIPTENAPP) for a "WASM app". What we want is that the same lool.html page adapts on demand to
m4_dnl# instead run locally using WASM, if the connection to the LOOL server breaks. (And then
...
[
  ...
  <input type="hidden" id="init-help-file" value="m4_syscmd([cat html/lool-help.html | sed 's/"/\&quot;/g'])" />
],
[
        ...
        <div id="about-dialog-container">
          ...
          <div id="about-dialog-info-container">
            <div id="about-dialog-info">
              ...
              <div class="about-dialog-info-div"><div id="loolwsd-version" dir="ltr"></div></div>
              <div class="spacer"></div>
              <div id="lokit-version-label"></div>
              <div class="about-dialog-info-div"><div id="lokit-version" dir="ltr"></div></div>
              m4_ifelse(MOBILEAPP,[],[<div id="served-by" style="display: none;"><span id="served-by-label"></span>&nbsp;<span id="os-info"></span>&nbsp;<wbr><span id="loolwsd-id"></span></div>],[<p></p>])
...
m4_ifelse(MOBILEAPP, [true],
     ...
     [
      ...
      data-lool-logging = "%BROWSER_LOGGING%"
      data-loolwsd-version = "%LOOLWSD_VERSION%"
...
m4_ifelse(MOBILEAPP,[true],
  ...
  m4_ifelse(BUNDLE, [], m4_foreachq([fileJS], [m4_include(LOOL_JS.m4)], [<script src="fileJS" defer></script>]), [<script src="bundle.js" defer></script>]),
  m4_ifelse(BUNDLE, [], m4_foreachq([fileJS], [m4_include(LOOL_JS.m4)],
