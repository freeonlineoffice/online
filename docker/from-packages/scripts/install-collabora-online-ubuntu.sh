...
if [ "$type" == "lool" ] && [ -n ${secret_key+set} ]; then
    ...
    echo "Based on the provided build arguments license key enabled LibreOffice Online will be used."
