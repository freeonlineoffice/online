    ...
    Poco::MemoryInputStream& message, const std::shared_ptr<StreamSocket>& socket)
{
    ...
    Poco::replaceInPlace(preprocess, std::string("%PROXY_PREFIX_ENABLED%"),
                         (LOOLWSD::IsProxyPrefixEnabled ? std::string("true") : std::string("false")));
    ...
    Poco::replaceInPlace(preprocess, std::string("%WASM_ENABLED%"), (LOOLWSD::getConfigValue<bool>("wasm.enable", false) ? std::string("true"): std::string("false")));
