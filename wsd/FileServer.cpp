    ...
    Poco::MemoryInputStream& message, const std::shared_ptr<StreamSocket>& socket)
{
    ...
    Poco::replaceInPlace(preprocess, std::string("%WASM_ENABLED%"), boolToString(LOOLWSD::getConfigValue<bool>("wasm.enable", false)));
    ...
    if (LOOLWSD::getConfigValue<bool>("extra_export_formats.impress_swf", false)) extraExportFormats += " impress_swf";
    if (LOOLWSD::getConfigValue<bool>("extra_export_formats.impress_bmp", false)) extraExportFormats += " impress_bmp";
    if (LOOLWSD::getConfigValue<bool>("extra_export_formats.impress_gif", false)) extraExportFormats += " impress_gif";
    if (LOOLWSD::getConfigValue<bool>("extra_export_formats.impress_png", false)) extraExportFormats += " impress_png";
    if (LOOLWSD::getConfigValue<bool>("extra_export_formats.impress_svg", false)) extraExportFormats += " impress_svg";
    if (LOOLWSD::getConfigValue<bool>("extra_export_formats.impress_tiff", false)) extraExportFormats += " impress_tiff";
