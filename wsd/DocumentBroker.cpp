...
DocumentBroker::DocumentBroker(ChildType type, const std::string& uri, const Poco::URI& uriPublic,
    ...
    , _saveManager(std::chrono::seconds(std::getenv("LOOL_NO_AUTOSAVE") != nullptr
                   ...
                   std::chrono::seconds(std::getenv("LOOL_NO_AUTOSAVE") != nullptr
                                            ? 0
                                            : LOOLWSD::getConfigValueNonZero<int>(
    ...
    , _backgroundAutoSave(LOOLWSD::getConfigValue<bool>("per_document.background_autosave", true))
    , _backgroundManualSave(
          LOOLWSD::getConfigValue<bool>("per_document.background_manualsave", true))
#if !MOBILEAPP
