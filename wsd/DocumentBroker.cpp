                                     ...
                                     const WopiStorage::WOPIFileInfo& wopiFileInfo)
{
    ...
    LOG_DBG("Creating new storage instance for URI [" << LOOLWSD::anonymizeUrl(uriPublic.toString())
                                                      << ']');
    ...
    [[maybe_unused]] std::unique_ptr<WopiStorage::WOPIFileInfo> wopiFileInfo)
{
    ...
    LOG_DBG("Setting username [" << LOOLWSD::anonymizeUsername(session->getUserName())
                                 << "] and userId ["
                                 << LOOLWSD::anonymizeUsername(session->getUserId())
