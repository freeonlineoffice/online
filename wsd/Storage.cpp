...
StorageBase::StorageType StorageBase::validate(const Poco::URI& uri, bool takeOwnership)
{
    ...
    {
        LOG_DBG("Public URI [" << LOOLWSD::anonymizeUrl(uri.toString()) << "] is a file");
    ...
    else if (HostUtil::isWopiEnabled())
    {
        ...
        {
            LOG_DBG("Validated URI [" << LOOLWSD::anonymizeUrl(uri.toString()) << "] as WOPI");
    ...
    LOG_DBG("No Storage configured or invalid URI [" << LOOLWSD::anonymizeUrl(uri.toString())
                                                     << ']');
                                                 ...
                                                 const std::string& jailPath, bool takeOwnership)
{
    ...
    switch (type)
    {
        case StorageBase::StorageType::Unsupported:
            LOG_ERR("Unsupported URI [" << LOOLWSD::anonymizeUrl(uri.toString())
