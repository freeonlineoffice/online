...
describe(['tagmobile'], 'Annotation tests.', function() {
	...
	it('Resolve comment.', function() {
		...
		cy.cGet('#mobile-wizard .wizard-comment-box .lool-annotation-content-resolved').should('exist');
		cy.cGet('#mobile-wizard .wizard-comment-box .lool-annotation-content-resolved').should('have.text', 'Resolved');
	});
});
